...
#Nummeric  vaiables like 'temp','atemp','hum','windspeed' are 
#standardized form

# data  contains  no  missing  values 
# Outliers might be present in variables 'casual','registered','cnt'
...
#It isstating that in all the season  weather 1 type is large numbers
...
# detect outliers in  'casual' , 'registered' and 'cnt' variables
